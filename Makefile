#############################################################################
# Makefile for building: passwordgen
# Generated by qmake (3.1) (Qt 6.7.2)
# Project:  passwordgen.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile passwordgen.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = passwordgen1.0.0
DISTDIR = /home/ailsong/Documentos/C_C++\ Programs/Password_Generator_C-/.tmp/passwordgen1.0.0
LINK          = g++
...
DIST          = /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		...
		passwordgen.pro src/genpass.hpp main.cpp
QMAKE_TARGET  = passwordgen
DESTDIR       = 
TARGET        = passwordgen
...
Makefile: passwordgen.pro /usr/lib64/qt6/mkspecs/linux-g++/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt6/mkspecs/common/unix.conf \
		/usr/lib64/qt6/mkspecs/common/linux.conf \
		/usr/lib64/qt6/mkspecs/common/sanitize.conf \
		/usr/lib64/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile passwordgen.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/genpass.hpp $(DISTDIR)/
...
main.o: main.cpp src/genpass.hpp
